...
@section('content')
    <div class="card">
        <div class="card-header">
            <h2 class="card-title">Nouvelle formation</h2>
        </div>
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        previewContainer.innerHTML = `
                            <p class="text-xs text-gray-500 mb-1">Prévisualisation :</p>
                            <img src="${e.target.result}" alt="Prévisualisation" class="h-32 object-cover rounded">
                        `;
                    };
